...
```csharp
public class ModularBaseUser<TKey> : ModularBaseUser`2, IModularBaseUser`2, IModularBaseUser`1
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → IdentityUser&lt;TKey&gt; → ModularBaseUser&lt;TKey, IdentityUserClaim&lt;TKey&gt;&gt; → [ModularBaseUser&lt;TKey&gt;](./jlw.extensions.identity.modularbaseuser-1.md)<br>
Implements IModularBaseUser&lt;TKey, IdentityUserClaim&lt;TKey&gt;&gt;, IModularBaseUser&lt;TKey&gt;
